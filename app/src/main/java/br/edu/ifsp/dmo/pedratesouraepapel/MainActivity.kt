...
import br.edu.ifsp.jukenpo.databinding.ActivityMainBinding
class MainActivity : AppCompatActivity() {
    ...
    private fun startGame() {
        ...
        val playAgainstBot = binding.checkboxBot.isChecked
        ...
        mIntent.putExtra(Constants.KEY_PLAY_AGAINST_BOT, playAgainstBot)
